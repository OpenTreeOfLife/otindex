...
# This file has been copied from the ws-tests directory of the
# phylesystem-api repository. Please propagate improvements to
# phylesystem-api/ws-tests/opentreetesting.py.
